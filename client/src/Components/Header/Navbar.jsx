...
export default function Navbar(){
    ...
    return(<div className={styles.navbar}>
        ...
        <ul className={hamburgerClicked ? `${styles.navMenu} ${styles.active}` : styles.navMenu} >
            <Link to='/'><li className={styles.navLinks} >About Us</li></Link>
            <Link to='/'><li className={styles.navLinks}>Offers</li></Link>
            <Link to='/'><li className={styles.navLinks}>Contact Us</li></Link>
            <Link to='/'><li className={styles.navLinks}>Lab Tests</li></Link>
            <Link to='/'><li className={styles.navLinks}>Sign Up</li></Link>
        </ul>
    </div>);
}
